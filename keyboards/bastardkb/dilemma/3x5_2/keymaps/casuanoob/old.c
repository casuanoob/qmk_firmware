...
#define OLED_RENDER_LAYOUT_NRSTEX "NRSTex"
#define OLED_RENDER_LAYOUT_APTMAK "APTmak"
#define OLED_RENDER_LAYOUT_ADEPT "Adept"
#define OLED_RENDER_LAYOUT_CANARY "Canary"
...
/**    oled_write_P(PSTR(OLED_RENDER_LAYOUT_NAME), false);
    switch (get_highest_layer(default_layer_state)) {
        case _APTmak2:
            oled_write_P(PSTR(OLED_RENDER_LAYOUT_NRSTEX), false);
            break;
        case _CLMKdh:
            oled_write_P(PSTR(OLED_RENDER_LAYOUT_COLEMAK_DH), false);
            break;
        case _nAPTmak:
            oled_write_P(PSTR(OLED_RENDER_LAYOUT_APTMAK), false);
            break;
        case _ADEPT:
            oled_write_P(PSTR(OLED_RENDER_LAYOUT_ADEPT), false);
        case _GAME:
...
#define OLED_KAKI_SPEED 40  // above this wpm value typing animation is triggered
